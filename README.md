...
## ✍️ Descrição
Exemplificação da sintaxe geral e básica da Linguagem Java
...
1. Clone:
    ...
    ```bash
    git clone git@github.com:cleibp/basic-java.git
    ```
1. Download:
    ### Download Manual
...
## 👋🏽 DEMO
[REPLIT](https://replit.com/@cleibp/Basic-Java#Main.java) 
